  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0" style="font-family:serif; font-size:xxx-large; text-align:center">المشكلة</h1>
            </div><!-- /.col -->
            <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                        <!-- form start -->
                          <form action="../backend/addSubCategory.php" method="post" style="text-align:right; font-family:serif;" dir="rtl">
                            <div class="card-body">
                              <div class="form-group" >
                                <label for="title" style="font-size:x-large">إضافة مشكلة جديدة </label>
                                <input type="text" class="form-control" name="title"  placeholder="إضافة مشكلة جديدة">
