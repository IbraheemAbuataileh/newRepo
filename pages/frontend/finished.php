    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2" style="margin-top:10px">
              <div class="col-sm-12">
                  <h1 style="text-align:center;font-family:serif; font-size:xxx-large;" class="m-0">البلاغلات المنتهية</h1>
              </div><!-- /.col -->
            <!-- <div class="col-sm-6">
                        ...
                        <table id="example1" dir="rtl" class="table table-bordered table-hover" >
                            ...
                            if(isset($_SESSION["type"]))
                            {
                              if($_SESSION["type"] == 1){
                                ...
                                WHERE c.id IS NULL AND b.stutes= 3";
                            }else{    
                              if($_SESSION["type"] == 2){
                                $sql = "SELECT a.*, b.stutes,e.title as cat_title, f.title as sub_cat_title 
                                FROM reports a JOIN states b ON (a.id = b.report_id) 
                                ...
                                INNER JOIN category as e on (a.cat_id = e.id) 
                                INNER JOIN sub_category as f on (a.sub_cat_id = f.id) 
                                WHERE c.id IS NULL AND b.stutes= 3 AND a.cat_id = '$_SESSION[cat_id]'";
                               }
                              }
                            }   
                            ...
                            // output data of each row
                                ...
                                // print_r($row);die();
                                    ...
                                    echo "<td>" . $row["date"]. "</td>";
                                    echo "<td><a class='btn btn-success' style='width:100%; font-family:serif' href='update_states.php?id=$row[id]'>عرض</a>";
