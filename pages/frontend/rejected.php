  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0" style="font-family:serif; font-size:xxx-large; text-align:center">البلاغات المرفوضة</h1>
            </div><!-- /.col -->
            <!-- <div class="col-sm-6">
                          ...
                          <tbody>
                            ...
                            if(isset($_SESSION["type"]))
                            {
                              if($_SESSION["type"] == 1){
                                ...
                                WHERE c.id IS NULL AND b.stutes= 4";
                              }else{
                                if($_SESSION["type"] == 2){
                                $sql = "SELECT a.*, b.stutes,b.reasion,e.title as cat_title, f.title as sub_cat_title 
                                FROM reports a JOIN states b ON (a.id = b.report_id) 
                                ...
                                INNER JOIN category as e on (a.cat_id = e.id) 
                                INNER JOIN sub_category as f on (a.sub_cat_id = f.id) 
                                WHERE c.id IS NULL AND b.stutes= 4 AND a.cat_id = '$_SESSION[cat_id]'";
                                }
                              }
                            }
